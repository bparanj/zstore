...
4.. By default, a PayPal account is not eligible to use Website Payments Pro. You must submit an online application and have your application approved by PayPal. 
5. Does Express Checkout require granting Third-Party API permission?
